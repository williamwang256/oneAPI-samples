...
This FPGA sample is a tutorial that demonstrates how to use host pipes to configure the data interfaces of an IP component generated by oneAPI. 
...
The following code example instantiates a `StreamingBeat` struct and writes to a pipe (from the host):
